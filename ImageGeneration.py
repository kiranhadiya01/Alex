...
async def query(payload):
    ...
    if response.status_code != 200:
        print("Error from API:", response.text[:500])  # Show first 500 chars
    ...
    for jpg_file in Files:
        ...
        try:
            ...
            img.show()
            sleep(1)  # Pause for a second to allow the image to display 
...
headers = {"Authorization": "Bearer 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"}
...
async def generate_images(prompt: str):
    ...
    for i, image_bytes in enumerate(image_bytes_list):
      print(f"Saving image {i+1}, size={len(image_bytes)} bytes")
...
while True:
    ...
    try:
        ...
        with open(r"C:\Users\Kiran\AppData\Local\Programs\Alex\Frontend\Files\ImageGeneration.data", "r") as f:
            Data: str = f.read()
        ...
        if Status == "True":
            ...
            with open(r"C:\Users\Kiran\AppData\Local\Programs\Alex\Frontend\Files\ImageGeneration.data", "w") as f:
                f.write("False,False")
