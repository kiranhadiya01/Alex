#This is for abel to speak like a real person
...
async def TextToAudioFile(text) -> None:
    ...
    communicate = edge_tts.Communicate(text, AssistantVoice, pitch="-2Hz", rate="+2%", volume="+20%")
...
def TTS(Text, func=lambda r=None: True):
    while True:
        try:
            ...
            except Exception as e:   # Handle any exceptions in the during cleanup 
...
if __name__ == "__main__":
    while True:
        ...
        # Ignore PowerShell commands or paths
        if user_input.lower().startswith("& c:/users") or user_input.endswith(".ps1"):
            continue
